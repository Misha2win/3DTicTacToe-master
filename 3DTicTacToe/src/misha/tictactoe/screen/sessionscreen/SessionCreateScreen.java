...
public class SessionCreateScreen extends TwoFieldInputScreen {
	...
	public SessionCreateScreen(ScreenManager manager) {
		super(manager);
	}
	...
	public void focused() {
		...
		super.nameField.setEditable(true);
		nameField.setText("");
	...
	public void setup() {
		...
		createButton = new Rectangle2D.Double(TicTacToe3D.width / 2 - width / 2, TicTacToe3D.height - 280, width, 80);
	...
	public void submitRequest() {
		screenManager.switchScreen(ScreenManager.SESSION_CREATE_WAIT_SCREEN);
		screenManager.getClient().sendMessage(
				MessageType.QUERY_CREATE_SESSION, 
				"2 " + TicTacToe3D.GAME_NAME + " " + nameField.getText() + " " + passwordField.getText(), 
				null
		);
	}
